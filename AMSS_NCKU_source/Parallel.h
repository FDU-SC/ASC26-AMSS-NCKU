...
namespace Parallel
{
  ...
  void transfer(MyList<gridseg> **src, MyList<gridseg> **dst,
                ...
                int Symmetry);
  int data_packer_prolong(double *data, MyList<gridseg> *src, MyList<gridseg> *dst, int rank_in, int dir,
                  MyList<var> *VarLists, MyList<var> *VarListd, int Symmetry);              
  void transfer_prolong(MyList<gridseg> **src, MyList<gridseg> **dst,
                MyList<var> *VarList1 /* source */, MyList<var> *VarList2 /*target */,
                int Symmetry);
  void transfer_prolong_fine_owned(Patch *Patf, MyList<gridseg> **transfer_src, MyList<gridseg> **transfer_dst,
                                   MyList<var> *VarList1 /* source */, MyList<var> *VarList2 /* target */,
                                   int Symmetry);
